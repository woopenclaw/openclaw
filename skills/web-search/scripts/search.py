...
Requirements:
    pip install ddgs  (recommended; duckduckgo-search is deprecated)
"""
...
# Try new ddgs package first (duckduckgo-search is deprecated and renamed)
_DDGS_PACKAGE = "ddgs"
try:
    ...
    try:
        ...
        _DDGS_PACKAGE = "duckduckgo_search"
